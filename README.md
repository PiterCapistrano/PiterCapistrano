...
Sou desenvolvedor de software com forte experiência em desenvolvimento Android, especializado em Kotlin, Java e Kotlin Multiplatform. Tenho sólida experiência na criação de interfaces de usuário utilizando Jetpack Compose, XML e Flutter, além de integração de APIs RESTful para comunicação entre cliente (App) e servidor, acesso a dados externos, escalabilidade e flexibilidade, armazenamento e gerenciamento de dados, autenticação e autorização, integração de serviços externos, suporte a operação CRUD, sincronização em tempo real e desacoplamento do Frontend e Backend. Atualmente, estou cursando o bacharelado em Engenharia de Software e possuo certificações em tecnologias emergentes e metodologias ágeis.

Tenho um grande interesse no desenvolvimento de soluções móveis inovadoras e eficientes, sempre com foco na experiência do usuário. Sou um colaborador ativo em equipes multidisciplinares, sempre em busca de criar aplicações intuitivas e funcionais. Minhas competências incluem tanto o backend (Kotlin, Java, Spring Boot e Dart) quanto o frontend (Jetpack Compose, XML e Flutter), além de experiência com bancos de dados como SQLite, Room, MySQL, PostgreSQL, e serviços da Firebase/Google e AWS.

Possuo amplo conhecimento de arquiteturas de software como MVVM, MVC, Microservices e Clean Architecture, além de habilidades em testes unitários com JUnit, simulação de dependências com Mockito, e Mocktail para mock de classes e funções. Também tenho experiência com Integração Contínua (CI) e Entrega/Implantação Contínua (CD), e sou familiarizado com ferramentas como Gradle e Maven para compilação de código, gerenciamento de dependências, configurações de builds e integração com outras ferramentas.

Minha abordagem é centrada em metodologias ágeis como Kanban e Scrum, e utilizo Git e GitHub para controle de versão e colaboração. Estou sempre em busca de aprimorar minhas habilidades, com foco em segurança e performance, para entregar soluções de software robustas e de alta qualidade.
